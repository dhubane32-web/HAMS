...
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f "$ROOT/database/rbac_airline_roles.sql"
...
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f "$ROOT/database/occ_control_center.sql"
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f "$ROOT/database/occ_control_center_v2.sql"
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f "$ROOT/database/sync_booking_md_routes_from_ops.sql"
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f "$ROOT/database/operations_airline_control_v2.sql"
